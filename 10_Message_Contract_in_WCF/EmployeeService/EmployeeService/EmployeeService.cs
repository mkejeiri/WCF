...
namespace EmployeeService
{
    ...
    {
        public EmployeeInfo GetEmployeeInfo(EmployeeRequest request)
        {
        ...
        public void SaveEmployee(EmployeeInfo employeeInfo)
        {
            ...
            using (SqlConnection con = new SqlConnection(cs))
            {
                ...
                if (employeeInfo.GetType() == typeof(FullTimeEmployee))
                {
                ...
                else if (employeeInfo.GetType() == typeof(PartTimeEmployee))
                {
